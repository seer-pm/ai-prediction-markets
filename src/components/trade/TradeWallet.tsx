...
export const TradeWallet = () => {
  ...
  const { data: checkTradeExecutorResult, isLoading } = useCheckTradeExecutorCreated(account);
          ...
          {isLoading ? (
            ...
            <>
              <p className="text-sm leading-relaxed text-slate-200 mb-6">
                Create a trade wallet to make multiple trades and redeem tokens in a single
                transaction.
              </p>
              <button
            ...
            <div className="space-y-3 p-6 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="text-xl font-semibold">
                  Trade Wallet{isUseOldWallet ? " (Deprecated)" : ""}
                </h3>
                <a
                  href={
                    blockExplorerUrl &&

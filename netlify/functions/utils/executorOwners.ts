...
function predictExecutorAddress(owner: Address, bytecode: Hex): Address {
...
/**
 * Both executor generations. People who traded before the redeploy hold positions under the
 * deprecated bytecode and never moved them, so skipping it loses those balances.
 */

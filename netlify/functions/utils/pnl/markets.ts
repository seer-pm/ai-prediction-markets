...
/** Fast-testnet factory — markets from it are excluded from every search. */
const FAST_TESTNET_FACTORY = "0x1246c7e5ac59ba73a45a62e3081b548f02f58e90";

/**
 * Kleros curation status is irrelevant to P/L, and Optimism has no curate registry, so the
 * upstream `curate.ts` (447 lines of TCR queries) is not ported. Markets simply come back
 * unverified.
 */
async function getSubgraphVerificationStatusList(
  _chainId: SupportedChain,
